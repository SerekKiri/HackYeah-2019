...
public class CountMap<T> extends HashMap<T, Integer> {
   ...
   */
  public List<Entry<T, Integer>> entriesSortedByValue() {

    List<Entry<T, Integer>> colorEntries = new ArrayList<>(entrySet());
   ...
   */
  public List<Entry<T, Integer>> entriesSortedByValue(final Comparator<T> ifEqualByThis) {
